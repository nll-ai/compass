...
- **Styleguide:** [docs/styleguide.md](styleguide.md) — typography, spacing, components, **Settings** and **Watch Targets** sidebar tabs (layout, a11y, responsive). User-visible Settings chrome must match the styleguide and satisfy R-NAV-6 / R-NAV-7 / R-SCH-* / R-TEAM-8; Watch Targets tab chrome must match §6 Watch Targets and R-SCAN-6 / R-SCAN-7; target ownership and read-only UI align with R-TEAM-16.

    ...
    <div className="stack">
      ...
      <section className="card stack" aria-labelledby="digest-scheduling-heading">
        <h2 id="digest-scheduling-heading" style={{ margin: 0, fontSize: "1rem" }}>
          Automatic digest timing
        </h2>
        <p className="muted" style={{ margin: 0, fontSize: "0.9rem" }}>
          Combined scans and digest emails follow <strong>your</strong> schedule on Settings—not per target. Use{" "}
      ...
      <section className="card stack" style={{ borderColor: "var(--color-error, #b91c1c)", borderWidth: 1 }}>
        ...
        <p className="muted" style={{ margin: 0 }}>
          Permanently delete this watch target and all associated signals and raw items. This cannot be undone.
        </p>
